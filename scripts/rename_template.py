...
It renames all the occurrences of rl_robot (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the rl_robot folder
        os.rename(
            os.path.join(root_dir_path, "exts", "rl_robot", "rl_robot"),
            os.path.join(root_dir_path, "exts", "rl_robot", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "rl_robot"), os.path.join(root_dir_path, "exts", new_name))
