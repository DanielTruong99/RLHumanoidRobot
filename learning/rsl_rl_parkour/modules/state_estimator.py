...
from ..utils import get_subobs_size, get_subobs_by_components, substitute_estimated_state


'''
    # ---- EstimatorMixin ----
    #* estimator_obs_components: a list of strings used to get obs slices
    ...
    #* estimator_target_components: a list of strings used to get obs slices
        estimator_target_components = ["lin_vel"]

    #* estimator_kwargs: a dictionary of kwargs for the state estimator
        estimator_kwargs = {
            'hidden_sizes': [128, 64],
            'nonlinearity': "CELU"
        }

    #* replace_state_prob: if 0~1, replace the actor observation with the estimated state with this probability
'''
class EstimatorMixin:
    def __init__(self,
        *args,
        estimator_obs_components= None, 
        estimator_target_components= None, 
        estimator_kwargs= dict(),
        use_actor_rnn= False, 
        replace_state_prob= 0.,
        **kwargs,
    ):
        super().__init__(
            *args,
