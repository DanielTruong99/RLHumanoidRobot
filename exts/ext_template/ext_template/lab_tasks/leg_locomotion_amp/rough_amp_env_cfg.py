...
class ObservationsCfg:
    ...
    class AMPCfg(ObsGroup):
        ...
        foot_pos = ObsTerm(
            func=custom_mdp.foot_positions_in_base_frame,
            params={
...
@configclass
class LegRobotRoughAMPEnvCfg(LocomotionVelocityRoughEnvCfg):
...
@configclass
class LegRobotRoughAMPEnvCfg_PLAY(LegRobotRoughAMPEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
